      ...
      <main>
        ...
        <section className="hero-section" style={{minHeight:'100vh',display:'flex',alignItems:'center',padding:'130px 52px 80px',position:'relative',overflow:'hidden',background:'linear-gradient(110deg, #FAFAF7 0%, #FAFAF7 45%, #EAE4DA 100%)'}}>
          ...
          <div className="hero-grid" style={{maxWidth:1240,margin:'0 auto',width:'100%',position:'relative',zIndex:1}}>
            <div>
              <div style={{fontSize:9.5,fontWeight:400,letterSpacing:'.28em',textTransform:'uppercase',color:'#B8956A',marginBottom:20,display:'flex',alignItems:'center',gap:10}}>
            ...
            <div id="analyse" style={{background:'#1C1C1C',padding:'32px'}}>
              <div style={{marginBottom:20}}>
                <div style={{fontSize:9,letterSpacing:'.22em',textTransform:'uppercase',color:'#B8956A',marginBottom:8}}>Analyse patrimoniale gratuite</div>
                <div style={{fontFamily:"'Cormorant Garamond',serif",fontSize:20,fontWeight:300,color:'#F6F4EF',lineHeight:1.3}}>Votre dossier, <em style={{fontStyle:'italic',color:'#B8956A'}}>directement</em> entre les bonnes mains.</div>
              </div>
              <Funnel/>
            </div>
          </div>
        ...
        <section className="section-pad" style={{padding:'96px 52px',background:'#F6F4EF'}}>
          <div style={{maxWidth:1240,margin:'0 auto'}}>
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-end',marginBottom:56,flexWrap:'wrap',gap:20}}>
              <div>
                <div style={{fontSize:9.5,letterSpacing:'.28em',textTransform:'uppercase',color:'#B8956A',marginBottom:14,display:'flex',alignItems:'center',gap:10}}>
                ...
                <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'clamp(30px,3.5vw,50px)',fontWeight:300,color:'#1C1C1C',lineHeight:1.15}}>
                  Un accompagnement <em style={{fontStyle:'italic',color:'#B8956A'}}>complet</em>,<br/>à chaque étape de votre vie.
                </h2>
              </div>
            </div>
            ...
            <div className="analyse-grid">
              <div>
                ...
                <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'clamp(26px,3.5vw,50px)',fontWeight:300,color:'#F6F4EF',lineHeight:1.15,marginBottom:16}}>
                  Votre dossier, <em style={{fontStyle:'italic',color:'#B8956A'}}>directement</em> entre les bonnes mains.
                </h2>
          ...
          <div style={{maxWidth:1240,margin:'0 auto'}}>
            <div style={{display:'flex',justifyContent:'space-between',alignItems:'flex-end',marginBottom:44,flexWrap:'wrap',gap:20}}>
              <div>
                ...
                <h2 style={{fontFamily:"'Cormorant Garamond',serif",fontSize:'clamp(30px,3.5vw,50px)',fontWeight:300,color:'#1C1C1C',lineHeight:1.15}}>
                  Articles & <em style={{fontStyle:'italic',color:'#B8956A'}}>guides</em> patrimoniaux
                </h2>
              </div>
            ...
            <div className="blog-grid">
              {ARTICLES.slice(0,3).map(a=>(
                <Link key={a.id} href={`/article/${a.slug}`} style={{background:'#FAFAF7',padding:'30px 26px',textDecoration:'none',display:'flex',flexDirection:'column'}}>
                  <div style={{fontSize:8.5,letterSpacing:'.22em',textTransform:'uppercase',color:'#B8956A',marginBottom:12}}>{a.tag}</div>
